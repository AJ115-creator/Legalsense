...
SCORE_THRESHOLD = 0.0  # Reranker scores are near-zero floats; no hard cutoff
LOW_CONFIDENCE_THRESHOLD = 0.002  # Below this avg reranker score → off-topic gate (only for queries without legal signals)
